...
const setup = require("../controllers/setupDraftController");
...
router.post("/:id/review-journey", requireAdmin, setup.reviewJobJourney);
router.post("/", requireAdmin, setup.endpoint(createJob));
router.get("/", requireAdmin, listJobs);
router.get("/:id", optionalAuth, getJob);
router.put("/:id", requireAdmin, setup.endpoint(updateJob));
router.patch("/:id/publish", requireAdmin, setup.endpoint(publishJob));
...
router.post("/:id/publish-boards", requireAdmin, setup.endpoint(publishBoards));
